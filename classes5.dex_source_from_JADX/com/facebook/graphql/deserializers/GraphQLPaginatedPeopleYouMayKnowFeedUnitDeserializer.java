...
public class GraphQLPaginatedPeopleYouMayKnowFeedUnitDeserializer {
    public static int m5563a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("all_users")) {
                    iArr[0] = C0245xd2646133.m5566a(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m5564a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5563a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5565a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
