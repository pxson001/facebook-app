...
public class GraphQLTopLevelCommentsConnectionDeserializer {
    public static int m6101a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[4];
    ...
    public static MutableFlatBuffer m6102a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m6101a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m6103a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
