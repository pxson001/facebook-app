...
public class GraphQLPaginatedPeopleYouMayKnowFeedUnitUsersEdgeDeserializer {
    ...
    public static MutableFlatBuffer m5570a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5569a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5571b(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
