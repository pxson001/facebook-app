...
public class GraphQLEventMembersConnectionDeserializer {
    public static int m4817a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[6];
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("count")) {
                    ...
                    iArr[1] = GraphQLEventMembersEdgeDeserializer.m4822b(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m4818a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4817a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m4819a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
        ...
        if (a != 0) {
            ...
            for (int i2 = 0; i2 < mutableFlatBuffer.c(a); i2++) {
                GraphQLEventMembersEdgeDeserializer.m4823b(mutableFlatBuffer, mutableFlatBuffer.m(a, i2), jsonGenerator, serializerProvider);
            }
            jsonGenerator.e();
        }
