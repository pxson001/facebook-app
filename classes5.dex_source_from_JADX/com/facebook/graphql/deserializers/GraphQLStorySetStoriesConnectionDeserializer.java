...
public class GraphQLStorySetStoriesConnectionDeserializer {
    public static int m5985a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[3];
    ...
    public static MutableFlatBuffer m5986a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5985a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5987a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
