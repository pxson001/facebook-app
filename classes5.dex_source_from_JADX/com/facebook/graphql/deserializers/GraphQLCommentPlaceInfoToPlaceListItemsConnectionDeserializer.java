...
public class GraphQLCommentPlaceInfoToPlaceListItemsConnectionDeserializer {
    public static int m4662a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[1];
    ...
    public static MutableFlatBuffer m4663a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4662a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
