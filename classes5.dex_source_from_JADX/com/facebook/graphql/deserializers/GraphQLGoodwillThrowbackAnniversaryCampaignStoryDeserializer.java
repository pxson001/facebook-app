...
public class GraphQLGoodwillThrowbackAnniversaryCampaignStoryDeserializer {
    public static int m5023a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[5];
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("anniversary_campaign")) {
                    ...
                    iArr[1] = GraphQLGoodwillThrowbackPermalinkColorPaletteDeserializer.m5053a(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m5024a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5023a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5025a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
