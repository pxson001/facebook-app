...
public class GraphQLMediaQuestionOptionDeserializer {
    public static int m5346a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[5];
    ...
    public static MutableFlatBuffer m5347a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5346a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
