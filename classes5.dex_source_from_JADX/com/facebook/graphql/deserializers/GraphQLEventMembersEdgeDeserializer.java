...
public class GraphQLEventMembersEdgeDeserializer {
    public static int m4820a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[3];
    ...
    public static int m4822b(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        ArrayList arrayList = new ArrayList();
        if (jsonParser.g() == JsonToken.START_ARRAY) {
            while (jsonParser.c() != JsonToken.END_ARRAY) {
                arrayList.add(Integer.valueOf(m4820a(jsonParser, flatBufferBuilder)));
            }
        }
    ...
    public static MutableFlatBuffer m4821a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4820a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m4823b(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
