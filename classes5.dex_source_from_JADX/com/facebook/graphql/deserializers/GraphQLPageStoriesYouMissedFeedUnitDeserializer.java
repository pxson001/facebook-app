...
public class GraphQLPageStoriesYouMissedFeedUnitDeserializer {
    public static int m5524a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[10];
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("cache_id")) {
                    ...
                    zArr[0] = true;
                    jArr[0] = jsonParser.F();
                } else if (i.equals("page_stories")) {
                    iArr[3] = GraphQLPageStoriesYouMissedFeedUnitStoriesConnectionDeserializer.m5527a(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m5525a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5524a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5526a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        ...
        if (g != 0) {
            ...
            GraphQLPageStoriesYouMissedFeedUnitStoriesConnectionDeserializer.m5529a(mutableFlatBuffer, g, jsonGenerator, serializerProvider);
        }
