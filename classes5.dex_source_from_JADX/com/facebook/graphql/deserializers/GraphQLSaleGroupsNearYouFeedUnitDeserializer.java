...
public class GraphQLSaleGroupsNearYouFeedUnitDeserializer {
    public static int m5842a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[11];
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("all_sale_groups")) {
                    iArr[0] = GraphQLSaleGroupsNearYouFeedUnitGroupsConnectionDeserializer.m5845a(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m5843a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m5842a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m5844a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
