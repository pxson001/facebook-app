...
public class GraphQLDebugFeedEdgeDeserializer {
    public static int m4709a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[9];
    ...
    public static MutableFlatBuffer m4710a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4709a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m4711b(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
