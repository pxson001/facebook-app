...
public class GraphQLEventMaybesConnectionDeserializer {
    public static int m4810a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
        int[] iArr = new int[5];
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("count")) {
                    ...
                    iArr[1] = GraphQLEventMaybesEdgeDeserializer.m4815b(jsonParser, flatBufferBuilder);
    ...
    public static MutableFlatBuffer m4811a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4810a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m4812a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
        ...
        if (a != 0) {
            ...
            for (int i2 = 0; i2 < mutableFlatBuffer.c(a); i2++) {
                GraphQLEventMaybesEdgeDeserializer.m4816b(mutableFlatBuffer, mutableFlatBuffer.m(a, i2), jsonGenerator, serializerProvider);
            }
            jsonGenerator.e();
        }
