...
public class GraphQLCommentsConnectionDeserializer {
    ...
    public static MutableFlatBuffer m4666a(JsonParser jsonParser, short s) {
        FlatBufferBuilder flatBufferBuilder = new FlatBufferBuilder(128);
        int a = m4665a(jsonParser, flatBufferBuilder);
        if (1 != 0) {
    ...
    public static void m4667a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
        jsonGenerator.f();
