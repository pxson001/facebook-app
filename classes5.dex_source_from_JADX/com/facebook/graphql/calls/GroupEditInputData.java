...
/* compiled from: publisher_type */
public final class GroupEditInputData extends GraphQlMutationCallInput {
    ...
    public enum GroupPurpose implements JsonSerializable {
        ...
        private GroupPurpose(String str) {
    ...
    public enum JoinApprovalSetting implements JsonSerializable {
        ...
        private JoinApprovalSetting(String str) {
            this.serverValue = str;
        }
    ...
    public enum PostApprovalSetting implements JsonSerializable {
        ...
        private PostApprovalSetting(String str) {
            this.serverValue = str;
        }
    ...
    public enum PostPermissionSetting implements JsonSerializable {
        ...
        private PostPermissionSetting(String str) {
            this.serverValue = str;
        }
    ...
    public enum VisibilitySetting implements JsonSerializable {
        ...
        private VisibilitySetting(String str) {
            this.serverValue = str;
        }
    ...
    public final GroupEditInputData m4437a(String str) {
        a("actor_id", str);
        return this;
    }

    public final GroupEditInputData m4438b(String str) {
        a("group_id", str);
        return this;
    }

    public final GroupEditInputData m4436a(VisibilitySetting visibilitySetting) {
        a("visibility_setting", visibilitySetting);
        return this;
    }

    public final GroupEditInputData m4435a(Source source) {
        a("source", source);
        return this;
    }

    public final GroupEditInputData m4434a(GroupPurpose groupPurpose) {
