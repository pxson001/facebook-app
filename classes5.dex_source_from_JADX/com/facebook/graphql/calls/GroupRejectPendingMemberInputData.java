...
public final class GroupRejectPendingMemberInputData extends GraphQlMutationCallInput {
    ...
    public enum Consequence implements JsonSerializable {
        ...
        private Consequence(String str) {
    ...
    public final GroupRejectPendingMemberInputData m4440a(String str) {
        a("actor_id", str);
        return this;
    }

    public final GroupRejectPendingMemberInputData m4441b(String str) {
        a("group_id", str);
        return this;
    }

    public final GroupRejectPendingMemberInputData m4442c(String str) {
        a("user_id", str);
        return this;
    }

    public final GroupRejectPendingMemberInputData m4439a(Source source) {
        a("source", source);
        return this;
    }
}
