...
public final class GroupBlockInputData extends GraphQlMutationCallInput {
    ...
    public final GroupBlockInputData m4431a(String str) {
        a("actor_id", str);
        return this;
    }

    public final GroupBlockInputData m4432b(String str) {
        a("group_id", str);
        return this;
    }

    public final GroupBlockInputData m4433c(String str) {
        a("user_id", str);
        return this;
    }

    public final GroupBlockInputData m4430a(Source source) {
        a("source", source);
        return this;
    }
}
