...
public final class GroupRemoveMemberInputData extends GraphQlMutationCallInput {
    ...
    public final GroupRemoveMemberInputData m4447a(String str) {
        a("actor_id", str);
        return this;
    }

    public final GroupRemoveMemberInputData m4448b(String str) {
        a("group_id", str);
        return this;
    }

    public final GroupRemoveMemberInputData m4449c(String str) {
        a("user_id", str);
        return this;
    }

    public final GroupRemoveMemberInputData m4446a(Source source) {
        a("source", source);
        return this;
    }
}
