...
/* compiled from: region_code */
public final class BookmarkRemoveFromFavoritesInputData extends GraphQlMutationCallInput {
    ...
    public final BookmarkRemoveFromFavoritesInputData m4316a(String str) {
        a("actor_id", str);
        return this;
    }

    public final BookmarkRemoveFromFavoritesInputData m4317b(String str) {
        a("removed_bookmark_id", str);
        return this;
    }

    public final BookmarkRemoveFromFavoritesInputData m4315a(Source source) {
        a("source", source);
        return this;
    }
}
