...
public final class GroupLeaveInputData extends GraphQlMutationCallInput {

    /* compiled from: publish_timestamp */
    public enum ReaddPolicy implements JsonSerializable {
        ALLOW_READD("ALLOW_READD"),
        PREVENT_READD("PREVENT_READD");
        
        protected final String serverValue;

        private ReaddPolicy(String str) {
