...
/* compiled from: refreshToken */
public enum BoostedComponentAppInputBoostedComponentApp implements JsonSerializable {
    ...
    private BoostedComponentAppInputBoostedComponentApp(String str) {
