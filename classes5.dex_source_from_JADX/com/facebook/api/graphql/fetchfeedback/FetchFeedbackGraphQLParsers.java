...
public class FetchFeedbackGraphQLParsers {

    /* compiled from: angora_attachment_profile_image_size */
    public final class FetchFeedbackBaseFeedbackParser {
        public static int m16539a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
            int[] iArr = new int[26];
        ...
        public static void m16540a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
            jsonGenerator.f();
