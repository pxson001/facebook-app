...
public final class zze<T> extends zza {
    private final T f6796a;

    private zze(T t) {
        this.f6796a = t;
    }

    public static <T> zzd m12698a(T t) {
        return new zze(t);
    }

    public static <T> T m12699a(zzd com_google_android_gms_dynamic_zzd) {
        if (com_google_android_gms_dynamic_zzd instanceof zze) {
            return ((zze) com_google_android_gms_dynamic_zzd).f6796a;
        }
