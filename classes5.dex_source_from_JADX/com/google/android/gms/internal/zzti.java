...
public final class zzti {
    public static final Object f6986a = new Object();

    public static int m13029a(int[] iArr) {
        return (iArr == null || iArr.length == 0) ? 0 : Arrays.hashCode(iArr);
    }

    public static int m13030a(long[] jArr) {
        return (jArr == null || jArr.length == 0) ? 0 : Arrays.hashCode(jArr);
    }

    public static int m13031a(Object[] objArr) {
        int i = 0;
    ...
    public static int m13032a(byte[][] bArr) {
        int i = 0;
    ...
    public static boolean m13033a(int[] iArr, int[] iArr2) {
        return (iArr == null || iArr.length == 0) ? iArr2 == null || iArr2.length == 0 : Arrays.equals(iArr, iArr2);
    }

    public static boolean m13034a(long[] jArr, long[] jArr2) {
        return (jArr == null || jArr.length == 0) ? jArr2 == null || jArr2.length == 0 : Arrays.equals(jArr, jArr2);
    }

    public static boolean m13035a(Object[] objArr, Object[] objArr2) {
    ...
    public static boolean m13036a(byte[][] bArr, byte[][] bArr2) {
