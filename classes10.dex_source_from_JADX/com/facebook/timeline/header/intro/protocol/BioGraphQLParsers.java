...
/* compiled from: fetch_guest_list_graphql */
public class BioGraphQLParsers {

    /* compiled from: fetch_guest_list_graphql */
    public final class BioQueryParser {

        /* compiled from: fetch_guest_list_graphql */
        public final class ProfileIntroCardParser {
            public static int m11910a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
                int[] iArr = new int[2];
            ...
            public static void m11911a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
                jsonGenerator.f();
        ...
        public static MutableFlatBuffer m11912a(JsonParser jsonParser) {
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("profile_intro_card")) {
                        iArr[0] = ProfileIntroCardParser.m11910a(jsonParser, flatBufferBuilder);
                    } else {
                        jsonParser.f();
                    }
                }
