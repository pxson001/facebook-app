...
/* compiled from: extra_finish_on_launch_view_shop */
public class SelfTimelineFeedStoryMenuHelper extends TimelineFeedStoryMenuHelper {
    ...
    protected final boolean mo559b(GraphQLStory graphQLStory) {
        return (graphQLStory.getType() == null || graphQLStory.getType().g() != 80218325 || graphQLStory.c() == null) ? false : true;
    }

    public final NegativeFeedbackExperienceLocation m12768a() {
