...
/* compiled from: canvas_resume */
public class EventsNotificationSettingsMutationsParsers {

    /* compiled from: canvas_resume */
    public final class EventUpdateNotificationSubscriptionLevelMutationParser {
        ...
        public final class EventParser {
                ...
                while (jsonParser.c() != JsonToken.END_OBJECT) {
                    ...
                    if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                        if (i.equals("id")) {
                            ...
                            iArr[1] = flatBufferBuilder.a(GraphQLEventNotificationSubscriptionLevel.fromString(jsonParser.o()));
                        } else {
                            jsonParser.f();
                        }
                    }
            ...
            public static void m18214a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator) {
                jsonGenerator.f();
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("client_mutation_id")) {
                        ...
                        iArr[1] = EventParser.m18213a(jsonParser, flatBufferBuilder);
                    } else {
                        jsonParser.f();
                    }
                }
