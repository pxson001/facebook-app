...
*/
    ...
    L_0x0004:
        r1 = com.facebook.saved.event.SavedEventBus.class;
        monitor-enter(r1);
        r0 = f9127a;	 Catch:{ all -> 0x0039 }
    ...
    L_0x000d:
        ...
        r0 = m9121a();	 Catch:{ all -> 0x0034 }
        f9127a = r0;	 Catch:{ all -> 0x0034 }
    ...
    L_0x003e:
        ...
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.saved.event.SavedEventBus.a(com.facebook.inject.InjectorLike):com.facebook.saved.event.SavedEventBus");
    }

    private static SavedEventBus m9121a() {
        return new SavedEventBus();
    }
}
