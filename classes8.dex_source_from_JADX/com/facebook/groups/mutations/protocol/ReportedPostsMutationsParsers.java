...
public class ReportedPostsMutationsParsers {

    /* compiled from: entity_cards_fragment_parameters */
    public final class GroupIgnoreReportedStoryCoreMutationParser {
        ...
        public static MutableFlatBuffer m17154a(JsonParser jsonParser) {
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("group")) {
                        iArr[0] = GroupParser.m17152a(jsonParser, flatBufferBuilder);
                    } else {
                        jsonParser.f();
                    }
                }
