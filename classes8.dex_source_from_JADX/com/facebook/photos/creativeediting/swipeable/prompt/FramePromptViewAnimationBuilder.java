...
public class FramePromptViewAnimationBuilder<V extends View & HasPromptFlyout & HasPhotoTray> extends ScrollingImagePromptViewAnimationBuilder<BaseTrayAnimatorListener, V> {
    @Inject
    public FramePromptViewAnimationBuilder(ScreenUtil screenUtil, DefaultAnimationPartFactory defaultAnimationPartFactory, @Assisted Context context) {
        super(screenUtil, defaultAnimationPartFactory, context.getResources().getDimensionPixelSize(2131429559));
    }

    public final BaseTrayAnimatorListener m2430a(V v, PromptHScrollView promptHScrollView, boolean z) {
