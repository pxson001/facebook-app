...
public class SearchResultsSeeMoreQueryParsers {

    /* compiled from: mini_preview_enabled */
    public final class SearchResultsSeeMoreQueryParser {
        ...
        public final class QueryTitleParser {
            ...
            public static void m9848a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator) {
                jsonGenerator.f();
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("query_function")) {
                        ...
                        iArr[1] = QueryTitleParser.m9847a(jsonParser, flatBufferBuilder);
        ...
        public static void m9850a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
            jsonGenerator.f();
            if (mutableFlatBuffer.g(i, 0) != 0) {
            ...
            if (g != 0) {
                ...
                QueryTitleParser.m9848a(mutableFlatBuffer, g, jsonGenerator);
            }
