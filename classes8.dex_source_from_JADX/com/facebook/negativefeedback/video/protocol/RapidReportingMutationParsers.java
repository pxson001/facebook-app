...
/* compiled from: text_metrics */
public class RapidReportingMutationParsers {

    /* compiled from: text_metrics */
    public final class RapidReportingMutationParser {
        ...
        public static MutableFlatBuffer m1832a(JsonParser jsonParser) {
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("story")) {
                        iArr[0] = StoryParser.m1830a(jsonParser, flatBufferBuilder);
                    } else {
                        jsonParser.f();
                    }
                }
