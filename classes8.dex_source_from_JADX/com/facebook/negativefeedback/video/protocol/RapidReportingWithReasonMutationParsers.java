...
/* compiled from: terms_url */
public class RapidReportingWithReasonMutationParsers {

    /* compiled from: terms_url */
    public final class RapidReportingWithReasonMutationParser {
        ...
        public static MutableFlatBuffer m1885a(JsonParser jsonParser) {
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("story")) {
                        iArr[0] = StoryParser.m1883a(jsonParser, flatBufferBuilder);
                    } else {
                        jsonParser.f();
                    }
                }
