...
public class ReactScrollViewManager$$PropsSetter implements ViewManagerSetter<ReactScrollViewManager, ReactScrollView> {
    public final void m19066a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                reactScrollViewManager.setAccessibilityLiveRegion(reactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
                reactScrollViewManager.setBackgroundColor(reactScrollView, reactStylesDiffMap.a(str, 0));
                return;
            case true:
                reactScrollViewManager.setDecomposedMatrix(reactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                reactScrollViewManager.setElevation(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                reactScrollView.setEndFillColor(reactStylesDiffMap.a(str, 0));
                return;
            case true:
                reactScrollViewManager.setImportantForAccessibility(reactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                reactScrollViewManager.setRenderToHardwareTexture(reactScrollView, reactStylesDiffMap.a(str, false));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                reactScrollView.f19085g = reactStylesDiffMap.a(str, true);
                return;
            case true:
                reactScrollView.f19088j = reactStylesDiffMap.c(str);
                return;
            case true:
                reactScrollView.f19086h = reactStylesDiffMap.a(str, false);
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                reactScrollViewManager.setTransform(reactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                reactScrollViewManager.setTranslateX(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                reactScrollViewManager.setTranslateY(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            default:
                return;
        }
    ...
    public final Map<String, String> m19065a() {
