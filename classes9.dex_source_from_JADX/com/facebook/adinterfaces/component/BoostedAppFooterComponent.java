...
/* compiled from: __tn__ */
public class BoostedAppFooterComponent implements AdInterfacesComponent<AdInterfacesFooterView, AdInterfacesDataModel> {
    private AdInterfacesBoostedAppFooterViewController f21627a;

    private static BoostedAppFooterComponent m22628b(InjectorLike injectorLike) {
        return new BoostedAppFooterComponent(AdInterfacesBoostedAppFooterViewController.m24534c(injectorLike));
    }

    @Inject
    BoostedAppFooterComponent(AdInterfacesBoostedAppFooterViewController adInterfacesBoostedAppFooterViewController) {
        this.f21627a = adInterfacesBoostedAppFooterViewController;
    }
