...
import com.facebook.adinterfaces.protocol.FetchCTAPromotionMethod;
...
public class PromoteCTAObjective implements AdInterfacesObjective {
    ...
    public final void mo969a(Intent intent, AdInterfacesDataModel$AdInterfacesDataModelCallback adInterfacesDataModel$AdInterfacesDataModelCallback) {
        this.f21909h.m24136a(intent.getStringExtra("page_id"), ObjectiveType.PROMOTE_CTA, AdInterfacesIntentUtil.a(intent), adInterfacesDataModel$AdInterfacesDataModelCallback);
    }
}
