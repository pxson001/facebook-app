...
public interface zzh extends IInterface {
        ...
        class zza implements zzh {
            ...
            public final void mo453a(int i, PendingIntent pendingIntent) {
                ...
                try {
                    ...
                    this.f6398a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public final void mo454a(int i, String[] strArr) {
                ...
                try {
                    ...
                    this.f6398a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public final void mo455b(int i, String[] strArr) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeStringArray(strArr);
                    this.f6398a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    mo454a(parcel.readInt(), parcel.createStringArray());
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
                    mo455b(parcel.readInt(), parcel.createStringArray());
                    return true;
                case 3:
                    parcel.enforceInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
                    mo453a(parcel.readInt(), parcel.readInt() != 0 ? (PendingIntent) PendingIntent.CREATOR.createFromParcel(parcel) : null);
                    return true;
                case 1598968902:
    ...
    void mo453a(int i, PendingIntent pendingIntent);

    void mo454a(int i, String[] strArr);

    void mo455b(int i, String[] strArr);
}
