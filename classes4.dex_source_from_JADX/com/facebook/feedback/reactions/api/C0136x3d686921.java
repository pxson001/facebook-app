...
public final class C0136x3d686921 {
    ...
    public final class FeedbackReactionSettingsParser {
        ...
        public final class ReactionInfosParser {
            ...
            public final class AnimationParser {
                ...
                public static void m3188a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator) {
                    jsonGenerator.f();
                ...
                while (jsonParser.c() != JsonToken.END_OBJECT) {
                    ...
                    if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                        if (i.equals("animation")) {
                            iArr[0] = AnimationParser.m3187a(jsonParser, flatBufferBuilder);
            ...
            public static void m3186b(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
                ...
                if (g != 0) {
                    ...
                    AnimationParser.m3188a(mutableFlatBuffer, g, jsonGenerator);
                }
        ...
        public static int m3183a(JsonParser jsonParser, FlatBufferBuilder flatBufferBuilder) {
            int[] iArr = new int[1];
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                String i = jsonParser.i();
                jsonParser.c();
                    ...
                    if (i.equals("reaction_infos")) {
                        ...
                        if (jsonParser.g() == JsonToken.START_ARRAY) {
                            while (jsonParser.c() != JsonToken.END_ARRAY) {
                                arrayList.add(Integer.valueOf(ReactionInfosParser.m3185b(jsonParser, flatBufferBuilder)));
                            }
                        }
        ...
        public static void m3184a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
            ...
            if (g != 0) {
                ...
                for (int i2 = 0; i2 < mutableFlatBuffer.c(g); i2++) {
                    ReactionInfosParser.m3186b(mutableFlatBuffer, mutableFlatBuffer.m(g, i2), jsonGenerator, serializerProvider);
                }
                jsonGenerator.e();
            }
            jsonGenerator.g();
    ...
    public static MutableFlatBuffer m3182a(JsonParser jsonParser) {
        ...
        while (jsonParser.c() != JsonToken.END_OBJECT) {
            ...
            if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                if (i.equals("feedback_reaction_settings")) {
                    iArr[0] = FeedbackReactionSettingsParser.m3183a(jsonParser, flatBufferBuilder);
                } else {
                    jsonParser.f();
                }
            }
