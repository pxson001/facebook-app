...
public class MqttThriftHeader implements TBase, Serializable, Cloneable {
    public static boolean f11047a = true;
    private static final TStruct f11048b = new TStruct("MqttThriftHeader");
    private static final TField f11049c = new TField("traceInfo", (byte) 11, (short) 1);
    ...
    public static MqttThriftHeader m11484b(TProtocol tProtocol) {
        String str = null;
        tProtocol.r();
        while (true) {
    ...
    public final void m11486a(TProtocol tProtocol) {
        tProtocol.a();
    ...
    public String toString() {
        return m11485a(1, f11047a);
    }

    public final String m11485a(int i, boolean z) {
