...
@GwtCompatible
/* compiled from: use Optional.orNull() instead of Optional.or(null) */
public final class ArrayListMultimap<K, V> extends AbstractListMultimap<K, V> {
    @VisibleForTesting
    transient int f1542a;
    ...
    public final /* bridge */ /* synthetic */ Collection mo419k() {
        return super.mo419k();
    }
    ...
    public static <K, V> ArrayListMultimap<K, V> m2971t() {
        return new ArrayListMultimap();
    }

    public static <K, V> ArrayListMultimap<K, V> m2970b(Multimap<? extends K, ? extends V> multimap) {
    ...
    public ArrayListMultimap(int i, int i2) {
        super(Maps.m812a(i));
        CollectPreconditions.m615a(i2, "expectedValuesPerKey");
        this.f1542a = i2;
    }

    private ArrayListMultimap(Multimap<? extends K, ? extends V> multimap) {
        this(multimap.mo421p().size(), multimap instanceof ArrayListMultimap ? ((ArrayListMultimap) multimap).f1542a : 3);
        mo408a(multimap);
    }

    final List<V> mo407a() {
        return new ArrayList(this.f1542a);
    }
