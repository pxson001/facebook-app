...
/* compiled from: Trying to access db from ui thread */
public class PermalinkProfileListFragmentGraphQLParsers {

    /* compiled from: Trying to access db from ui thread */
    public final class PermalinkProfileListFragmentGraphQLParser {
        ...
        public final class ProfilePictureParser {
            ...
            public static void m24378a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator) {
                jsonGenerator.f();
        ...
        public static MutableFlatBuffer m24379a(JsonParser jsonParser) {
            ...
            while (jsonParser.c() != JsonToken.END_OBJECT) {
                ...
                if (!(jsonParser.g() == JsonToken.VALUE_NULL || i == null)) {
                    if (i.equals("__type__")) {
                        ...
                        iArr[3] = MutualFriendsParser.a(jsonParser, flatBufferBuilder);
                    } else if (i.equals("name")) {
                        iArr[4] = flatBufferBuilder.b(jsonParser.o());
                    } else if (i.equals("profile_picture")) {
                        iArr[5] = ProfilePictureParser.m24377a(jsonParser, flatBufferBuilder);
        ...
        public static void m24380a(MutableFlatBuffer mutableFlatBuffer, int i, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
            ...
            if (g != 0) {
                ...
                MutualFriendsParser.a(mutableFlatBuffer, g, jsonGenerator);
            }
            ...
            if (g != 0) {
                ...
                ProfilePictureParser.m24378a(mutableFlatBuffer, g, jsonGenerator);
            }
