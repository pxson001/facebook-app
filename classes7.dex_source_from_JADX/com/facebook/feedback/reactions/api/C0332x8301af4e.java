...
public class C0332x8301af4e extends JsonSerializer<ReactionInfosModel> {
    public final void m4498a(Object obj, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) {
    ...
    static {
        FbSerializerProvider.a(ReactionInfosModel.class, new C0332x8301af4e());
    }
}
