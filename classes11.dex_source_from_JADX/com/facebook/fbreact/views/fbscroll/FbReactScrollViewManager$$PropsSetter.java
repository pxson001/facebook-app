...
/* compiled from: endY */
public class FbReactScrollViewManager$$PropsSetter implements ViewManagerSetter<FbReactScrollViewManager, FbReactScrollView> {
    public final void m8653a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        FbReactScrollViewManager fbReactScrollViewManager = (FbReactScrollViewManager) viewManager;
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                fbReactScrollViewManager.setAccessibilityLiveRegion(fbReactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
                fbReactScrollViewManager.setBackgroundColor(fbReactScrollView, reactStylesDiffMap.a(str, 0));
                return;
            case true:
                fbReactScrollViewManager.setContentInset(fbReactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                fbReactScrollViewManager.setDecomposedMatrix(fbReactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                fbReactScrollViewManager.setElevation(fbReactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                ...
                return;
            case true:
                fbReactScrollViewManager.setImportantForAccessibility(fbReactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                fbReactScrollViewManager.setRenderToHardwareTexture(fbReactScrollView, reactStylesDiffMap.a(str, false));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                fbReactScrollViewManager.setTransform(fbReactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                fbReactScrollViewManager.setTranslateX(fbReactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                fbReactScrollViewManager.setTranslateY(fbReactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            default:
                return;
        }
    ...
    public final Map<String, String> m8652a() {
