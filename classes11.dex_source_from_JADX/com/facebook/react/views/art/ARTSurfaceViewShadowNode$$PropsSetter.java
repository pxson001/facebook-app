...
/* compiled from: SEND_PRIVACY_EDITS */
public class ARTSurfaceViewShadowNode$$PropsSetter implements ShadowNodeSetter<ARTSurfaceViewShadowNode> {
    public final void m11792a(ReactShadowNode reactShadowNode, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                aRTSurfaceViewShadowNode.setBottom(reactStylesDiffMap.a(str, Float.NaN));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                aRTSurfaceViewShadowNode.setLeft(reactStylesDiffMap.a(str, Float.NaN));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                aRTSurfaceViewShadowNode.k = reactStylesDiffMap.a(str, false);
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                aRTSurfaceViewShadowNode.setRight(reactStylesDiffMap.a(str, Float.NaN));
                return;
            case true:
                aRTSurfaceViewShadowNode.setTop(reactStylesDiffMap.a(str, Float.NaN));
                return;
            case true:
    ...
    public final Map<String, String> m11791a() {
