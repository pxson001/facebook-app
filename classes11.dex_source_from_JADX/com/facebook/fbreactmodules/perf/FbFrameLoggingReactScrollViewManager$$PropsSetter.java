...
/* compiled from: earlier_process_count */
public class FbFrameLoggingReactScrollViewManager$$PropsSetter implements ViewManagerSetter<FbFrameLoggingReactScrollViewManager, ReactScrollView> {
    public final void m8721a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        FbFrameLoggingReactScrollViewManager fbFrameLoggingReactScrollViewManager = (FbFrameLoggingReactScrollViewManager) viewManager;
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setAccessibilityLiveRegion(reactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setBackgroundColor(reactScrollView, reactStylesDiffMap.a(str, 0));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setDecomposedMatrix(reactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setElevation(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                reactScrollView.setEndFillColor(reactStylesDiffMap.a(str, 0));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setImportantForAccessibility(reactScrollView, reactStylesDiffMap.c(str));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setRenderToHardwareTexture(reactScrollView, reactStylesDiffMap.a(str, false));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setTransform(reactScrollView, reactStylesDiffMap.e(str));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setTranslateX(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                fbFrameLoggingReactScrollViewManager.setTranslateY(reactScrollView, reactStylesDiffMap.a(str, 0.0f));
                return;
            default:
                return;
        }
    ...
    public final Map<String, String> m8720a() {
