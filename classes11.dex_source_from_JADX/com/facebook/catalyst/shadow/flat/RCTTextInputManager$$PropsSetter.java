...
/* compiled from: listener must not be null */
public class RCTTextInputManager$$PropsSetter implements ViewManagerSetter<RCTTextInputManager, ReactEditText> {
    public final void m7177a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                rCTTextInputManager.setAccessibilityLiveRegion(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setAutoCapitalize(reactEditText, reactStylesDiffMap.a(str, 0));
                return;
            case true:
                Boolean valueOf;
                ...
                rCTTextInputManager.setAutoCorrect(reactEditText, valueOf);
                return;
            case true:
                rCTTextInputManager.setBackgroundColor(reactEditText, reactStylesDiffMap.a(str, 0));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                rCTTextInputManager.setDecomposedMatrix(reactEditText, reactStylesDiffMap.e(str));
                return;
            case true:
                reactEditText.setEnabled(reactStylesDiffMap.a(str, true));
                return;
            case true:
                rCTTextInputManager.setElevation(reactEditText, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                rCTTextInputManager.setFontFamily(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setFontSize(reactEditText, reactStylesDiffMap.a(str, 14.0f));
                return;
            case true:
                rCTTextInputManager.setFontStyle(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setFontWeight(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setImportantForAccessibility(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setKeyboardType(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                if (!reactStylesDiffMap.b(str)) {
                    num = Integer.valueOf(reactStylesDiffMap.a(str, 0));
                ...
                return;
            case true:
                rCTTextInputManager.setMultiline(reactEditText, reactStylesDiffMap.a(str, false));
                return;
            case true:
                reactEditText.setLines(reactStylesDiffMap.a(str, 1));
                return;
            case true:
                rCTTextInputManager.setOnSelectionChange(reactEditText, reactStylesDiffMap.a(str, false));
                return;
            case true:
                reactEditText.setAlpha(reactStylesDiffMap.a(str, 1.0f));
                return;
            case true:
                rCTTextInputManager.setPassword(reactEditText, reactStylesDiffMap.a(str, false));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                rCTTextInputManager.setRenderToHardwareTexture(reactEditText, reactStylesDiffMap.a(str, false));
                return;
            case true:
                rCTTextInputManager.setReturnKeyLabel(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setReturnKeyType(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                rCTTextInputManager.setTextAlign(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setTextAlignVertical(reactEditText, reactStylesDiffMap.c(str));
                return;
            case true:
                rCTTextInputManager.setTransform(reactEditText, reactStylesDiffMap.e(str));
                return;
            case true:
                rCTTextInputManager.setTranslateX(reactEditText, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                rCTTextInputManager.setTranslateY(reactEditText, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                if (!reactStylesDiffMap.b(str)) {
                    num = Integer.valueOf(reactStylesDiffMap.a(str, 0));
    ...
    public final Map<String, String> m7176a() {
