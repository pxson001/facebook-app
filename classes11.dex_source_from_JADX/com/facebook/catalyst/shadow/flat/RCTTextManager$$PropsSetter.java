...
/* compiled from: link_share_title_bar_back */
public class RCTTextManager$$PropsSetter implements ViewManagerSetter<RCTTextManager, FlatViewGroup> {
    public final void m7198a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        RCTTextManager rCTTextManager = (RCTTextManager) viewManager;
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                rCTTextManager.setAccessibilityLiveRegion(flatViewGroup, reactStylesDiffMap.c(str));
                return;
            case true:
                reactStylesDiffMap.a(str, 0);
                return;
            case true:
                rCTTextManager.setDecomposedMatrix(flatViewGroup, reactStylesDiffMap.e(str));
                return;
            case true:
                rCTTextManager.setElevation(flatViewGroup, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                rCTTextManager.setImportantForAccessibility(flatViewGroup, reactStylesDiffMap.c(str));
                return;
            case true:
                flatViewGroup.setAlpha(reactStylesDiffMap.a(str, 1.0f));
                return;
            case true:
                rCTTextManager.setRenderToHardwareTexture(flatViewGroup, reactStylesDiffMap.a(str, false));
                return;
            case true:
            ...
            case true:
                ...
                return;
            case true:
                rCTTextManager.setTransform(flatViewGroup, reactStylesDiffMap.e(str));
                return;
            case true:
                rCTTextManager.setTranslateX(flatViewGroup, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                rCTTextManager.setTranslateY(flatViewGroup, reactStylesDiffMap.a(str, 0.0f));
                return;
            default:
                return;
        }
    ...
    public final Map<String, String> m7197a() {
