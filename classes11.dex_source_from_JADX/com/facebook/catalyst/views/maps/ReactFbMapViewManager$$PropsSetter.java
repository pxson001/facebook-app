...
/* compiled from: last_selected_privacy */
public class ReactFbMapViewManager$$PropsSetter implements ViewManagerSetter<ReactFbMapViewManager, MapView> {
    public final void m7254a(ViewManager viewManager, View view, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        switch (z) {
            ...
            case true:
                ...
                return;
            case true:
                reactFbMapViewManager.setAccessibilityLiveRegion(mapView, reactStylesDiffMap.c(str));
                return;
            case true:
                reactFbMapViewManager.setActive(mapView, reactStylesDiffMap.a(str, true));
                return;
            case true:
                reactFbMapViewManager.setBackgroundColor(mapView, reactStylesDiffMap.a(str, 0));
                return;
            case true:
                reactFbMapViewManager.setDecomposedMatrix(mapView, reactStylesDiffMap.e(str));
                return;
            case true:
                reactFbMapViewManager.setElevation(mapView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                reactFbMapViewManager.setImportantForAccessibility(mapView, reactStylesDiffMap.c(str));
                return;
            case true:
            ...
            case true:
                ...
                reactFbMapViewManager.setPitchEnabled(mapView, bool);
                return;
            case true:
                reactFbMapViewManager.setRegion(mapView, reactStylesDiffMap.e(str));
                return;
            case true:
                reactFbMapViewManager.setRenderToHardwareTexture(mapView, reactStylesDiffMap.a(str, false));
                return;
            case true:
                if (!reactStylesDiffMap.b(str)) {
                    bool = Boolean.valueOf(reactStylesDiffMap.a(str, false));
                }
                reactFbMapViewManager.setRotateEnabled(mapView, bool);
                return;
            case true:
            ...
            case true:
                ...
                reactFbMapViewManager.setScrollEnabled(mapView, bool);
                return;
            case true:
                reactFbMapViewManager.setShowsUserLocation(mapView, reactStylesDiffMap.a(str, false));
                return;
            case true:
                mapView.setTag(reactStylesDiffMap.c(str));
                return;
            case true:
                reactFbMapViewManager.setTransform(mapView, reactStylesDiffMap.e(str));
                return;
            case true:
                reactFbMapViewManager.setTranslateX(mapView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                reactFbMapViewManager.setTranslateY(mapView, reactStylesDiffMap.a(str, 0.0f));
                return;
            case true:
                if (!reactStylesDiffMap.b(str)) {
                    bool = Boolean.valueOf(reactStylesDiffMap.a(str, false));
                }
                reactFbMapViewManager.setZoomEnabled(mapView, bool);
                return;
            default:
                return;
        }
    ...
    public final Map<String, String> m7253a() {
